    ...
    <div class="row">
      <div class="col-lg-12 col-12 d-flex flex-wrap">
        <p class="d-flex me-4 mb-0">
          ...
          <strong class="text-dark" style="font-size: 18px;">Bienvenido a licoreria Neos</strong>
        </p>
      </div>
    </div>
  </div>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav align-items-lg-center ms-auto me-lg-5">
          ...
          <slot v-if="authStore.token">
            ...
            <li class="nav-item">
              <RouterLink to="/detalles" class="nav-link click-scroll">Venta</RouterLink>
            </li>
            <!-- <li class="nav-item">
              <RouterLink to="/ventas" class="nav-link click-scroll">Detalles</RouterLink>
            </li>
             -->
            <li class="nav-item">
